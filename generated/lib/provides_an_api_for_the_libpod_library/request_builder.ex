...
defmodule ProvidesAnAPIForTheLibpodLibrary.RequestBuilder do
  @moduledoc """
  ...
  defp decode(%Tesla.Env{body: body}, %{}) do
    ProvidesAnAPIForTheLibpodLibrary.Deserializer.json_decode(body)
  end

  defp decode(%Tesla.Env{body: body}, module) do
    ProvidesAnAPIForTheLibpodLibrary.Deserializer.json_decode(body, module)
  end
end
