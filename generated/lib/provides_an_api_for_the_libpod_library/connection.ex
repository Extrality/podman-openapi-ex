...
defmodule ProvidesAnAPIForTheLibpodLibrary.Connection do
  @moduledoc """
  Handle Tesla connections for ProvidesAnAPIForTheLibpodLibrary.
  ...
  @doc """
  Configure a ProvidesAnAPIForTheLibpodLibrary client.

  ### Parameters

  - `options`: an optional keyword list of ProvidesAnAPIForTheLibpodLibrary.Connection.options.
  ...
  def middleware(options \\ []) do
    base_url =
      Keyword.get(
        options,
        :base_url,
        Application.get_env(:podman_openapi, :base_url, @default_base_url)
      )
    ...
    user_agent =
      Keyword.get(
        ...
        Keyword.get(
          tesla_options,
          :user_agent,
          "openapi-generator - ProvidesAnAPIForTheLibpodLibrary 1.0.0 - elixir"
        )
      )
